...
pollserver: recv from fd 5: hi
pollserver: new connection from 127.0.0.1 on socket 6
pollserver: recv from fd 6: hello from client
pollserver: recv from fd 4: hello form client 
pollserver: socket 4 hung up
pollserver: socket 5 hung up
pollserver: socket 6 hung up
